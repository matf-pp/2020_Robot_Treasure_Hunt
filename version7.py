...
def pocetniEkran():
    ...
    label = font2.render("Try to find a treasure!", 1, (88, 88, 88))
    label1= font2.render("Instructions: Start the game by clicking on the desired field.",1,(88,88,88))
    label2= font2.render("The treasure you will find by using the up, down, left and right arrows.",1,(88,88,88))
    label3= font2.render("Tip: Be careful, maybe obstacles come your way. Good luck!",1,(88,88,88))
